...
export function createFirstMessage(payload: any) {
    return "Hello, I'm ready to chat!";
}

export function createSystemPrompt(chatHistory: any, payload: any) {
    return "You are a helpful AI assistant.";
}

export function getChatHistory(supabase: any, userId: string, personalityKey: string | null, includeAudio: boolean) {
    return [];
}
